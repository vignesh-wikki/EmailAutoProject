...
const Dashboard = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#9de3f6]">
      <Navbar />
      <div className="">
      ...
      <div>
        ...
        {recentCampaigns.length === 0 ? (
          ...
          <div className="justify-between  rounded-[22px] m-28 flex  p-1">
          ...
          recentCampaigns.map((campaign) => (
            ...
            >
              ...
              <div class="flex text-white">
                ...
                <a
                  href="#"
                  class="px-3 py-2 text-sm  h-8 items-end font-medium text-center text-white rounded-[5px] hover:font-extrabold hover:text-white "
                >
                  Preview
                </a>
              </div>
      ...
      <div>
        ...
        {scheduledCampaigns.length === 0 ? (
          // Render this when there are no scheduled campaigns
          <div className=" flex justify-between  m-28 rounded-[22px] ">
      ...
      <div className="mt-10">
        <div className="justify-between ms-[4rem] bg-[#0C2136]  rounded-[22px] flex shadow-2xl m-12 p-7">
          <div className="text-white">
            <p className="text-xl font-semibold pb-3">Explore Templets:</p>
          ...
          <div className="flex text-white">
            <Link to="/email/template">
              <button className="hover:font-extrabold rounded-[5px] p-2 mt-2 mb-2 ps-3 pe-3">
                Explore Now
              </button>
            </Link>
          </div>
        ...
        <div className="justify-between ms-[4rem] bg-[#0C2136]  rounded-[22px] flex shadow-2xl m-12 p-7">
          <div className="text-white">
            <p className="text-xl font-semibold pb-3">Track Your Success:</p>
            <p className="font-normal">
              Mentor your Campaign and find your strategies
            </p>
          </div>
          <div className="flex text-white">
            <Link to="/report">
