...
const Report = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="pt-7 pb-10 justify-center rounded-[22px] border ">
        <div className="flex text-gray-500 pb-7 border">
          <p  className={`ps-40 pe-60 text-[#A1A1A1] rounded   hover:underline underline-offset-[0.4rem] cursor-pointer ${
              showScheduled ? 'md:hover:bg-transparent  dark:text-white  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:underline underline-offset-[0.4rem]' : ''
            }`}             
             onClick={() => setShowScheduled(true)}>Current Campagins</p>
          <p  className={`ps-60 pe-40 text-[#A1A1A1] rounded cursor-pointer   hover:underline underline-offset-[0.4rem] ${
              !showScheduled ? 'md:hover:bg-transparent  dark:text-white  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:underline underline-offset-[0.4rem]' : ''
            }`}            
