          ...
          <Modal.Footer>
            <div className=" ps-4">
              <button
                ...
                className="p-2 px-4  text-white hover:bg-[#21b6a8] bg-[#53dfd1] font-medium rounded-lg border black hover:bg-gray"
              >
                save
              </button>
            </div>
            ...
            <Modal.Footer>
              <div className="ps-4">
                <button
                  ...
                  className="p-2 px-4 text-white bg-[#53dfd1] hover:bg-[#21b6a8] font-medium rounded-lg border black hover:bg-gray"
                >
              ...
              {!isEditing && (
                <div className="ps-4">
                  <button
                    onClick={handleEdit}
                    className="p-2 px-4  hover:text-[#21b6a8]  hover:bg-gray-50 text-black  font-medium rounded-lg border black hover:bg-gray"
                  >
                    Edit
                  </button>
                </div>
