    ...
    <>
      <div>
        ...
        <div className="flex container mx-auto justify-between mt-10 w-[75%]">
          <button
            type="submit"
            class="inline-flex items-center h-10 px-8 ml-2 text-sm font-medium text-[#A1A1A1] bg-[#E0E0E0] rounded-lg border border-[#E0E0E0] hover:bg-[#E0E0E0] focus:ring-1 focus:ring-opacity-50 focus:outline-none focus:ring-[#0C2136] dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Search
            <svg
              class="w-4 h-4 ml-2"
        ...
        <div className="flex flex-col container mx-auto justify-center mt-10">
          {campaigns.length === 0 ? (
            ...
            <div className="justify-between rounded-[22px] flex m-28 p-1">
            ...
            campaigns.map((campaign) => (
              <div
                key={campaign.id}
                class="max-w-xxl flex mb-10 container mx-auto justify-between w-[80%] p-4  rounded-2xl shadow-xl dark:bg-gray-800 dark:border-gray-700"
              >
                <div>
                  <a href="#">
                    <h5 className="mb-2 text-2xl font-medium tracking-tight text-[#0C2136] dark:text-white">
                      {campaign.campaignName}
                    </h5>
                  </a>
                  <p className="mb-3 ml-1 font-normal text-[#0C2136]  dark:text-gray-400">
                    {campaign.subjectLine}
                  </p>
                </div>
                <div class="flex mt-5">
                  <div class="text-center mt-1">
                    <a class="px-3 py-2 text-sm  font-medium">Clicks</a>
                  ...
                  <a
                    href="#"
                    class="px-3 py-2 text-sm  h-8 items-end font-medium text-center text-[#0C2136] rounded-md hover:bg-[#FF8E2A] hover:text-white focus:ring-1 focus:outline-none focus:ring-[#E0E0E0] dark:bg-[#E0E0E0] dark:hover:bg-[#E0E0E0] dark:focus:ring-[#E0E0E0]"
                  >
                    Preview
                  </a>
                </div>
